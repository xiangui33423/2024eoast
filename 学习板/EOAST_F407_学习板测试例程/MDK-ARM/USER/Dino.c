...
void play() {
  ...
  for (;;) {
    ...
    if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_9 ) == GPIO_PIN_SET || HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_5) == GPIO_PIN_SET ||
			HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_2 ) == GPIO_PIN_SET || HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_4) == GPIO_PIN_SET) {
      if (jump == 0) jump = 1;
    }
